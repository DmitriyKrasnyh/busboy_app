  ...
  return (
    ...
    >
      <div
        {...listeners}
        {...attributes}
        className={`w-full h-full bg-white border-2 border-gray-300 rounded-lg flex items-center justify-center font-medium text-gray-800 cursor-grab active:cursor-grabbing transition-all duration-200 hover:border-blue-400 hover:shadow-md ${
